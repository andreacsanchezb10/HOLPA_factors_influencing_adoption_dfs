...
zwe_data_clean<-zwe_data_clean%>%
  ...
  mutate(metric_distance_closest_farmland= case_when(country=="zimbabwe"~ "minutes",TRUE~"NA"),
         ...
         metric_distance_primary_school=case_when(country=="zimbabwe"~ "minutes",TRUE~"NA"),
         metric_distance_hospital=case_when(country=="zimbabwe"~ "minutes",TRUE~"NA"),
         ...
         metric_distance_public_transport=case_when(country=="zimbabwe"~ "minutes",TRUE~"NA"),
