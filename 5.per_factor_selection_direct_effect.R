...
dim(per_data_nzvFiltered) #200 farmers; 194 variables retained
...
dim(per_data_irrelevantFiltered) #200 farmers; 175 variables retained
...
dim(per_data_redundantFiltered) #200 farmers; 147 variables
